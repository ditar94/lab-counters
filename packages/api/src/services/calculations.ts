...
export function calculateResults(
  ...
  switch (type) {
    case 'hemocytometer':
      return calculateHemocytometer(data as HemocytometerData);
    case 'fetal':
      return calculateFetal(data as FetalData);
    case 'retic':
 ...
 */
function calculateHemocytometer(data: HemocytometerData): HemocytometerCalculations {
 ...
 */
function calculateFetal(data: FetalData): FetalCalculations {
